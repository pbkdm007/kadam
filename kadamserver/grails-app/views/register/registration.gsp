  ...
  <g:cssBackgroundSetting selector=".login-page" setting="${Settings.findByName('loginBackground').value}"></g:cssBackgroundSetting>
    ...
    <div class="${hasusernameclass}">
		...
		<div class="${haspasswordclass}">
          ...
          <input type="hidden" name="surl" value="https://kadam-app.in/register/success"/>
          <input type="hidden" name="furl" value="https://kadam-app.in/register/error"/>
          <input type="hidden" name="curl" value="https://kadam-app.in/register/show" />
